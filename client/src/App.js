        ...
        await window.klaytn._kaikas.isApproved().then((result) => {
          if (result === true) {
            ...
            caver.klay.getAccounts().then(async (account) => {
              ...
              await axios
                .post("www.thekift.shop:8080/klaytn/sign", params, {
                  headers,
                })
                .then((result) => {
                  console.log(result);
              ...
              try {
                ...
                web.eth.getAccounts().then(async (account) => {
                  if (account.length === 0) {
                    ...
                    await axios
                      .post("www.thekift.shop:8080/sign", params, {
                        headers,
                      })
                      .then((res) => {
                        console.log(res);
          ...
          try {
            ...
            web.eth.getAccounts().then(async (account) => {
              if (account.length === 0) {
                ...
                await axios.post("www.thekift.shop:8080/sign", params, { headers }).then((res) => {
                  console.log(res);
                });
              }
            });
