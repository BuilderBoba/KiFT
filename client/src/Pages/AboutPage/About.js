...
function About({ loginAccount, isKaikas /* 로그인된 계정 */ }) {
  ...
  async function loadSellItem() {
    ...
    await axios
      .post(
        "www.thekift.shop:8080/searchNFT",
        {
          openseaId: URLparam,
        },
        headers
  ...
  async function loadSellItemOnKlay() {
    ...
    await axios
      .post(
        "www.thekift.shop:8080/klaytn/searchNFT",
        {
          openseaId: URLparam,
        },
        headers
  ...
  async function listNFTOnTheMarket(result) {
    ...
    await axios
      .post(
        "www.thekift.shop:8080/listItemOnlist",
        {
          openseaId: URLparam,
      ...
      .then(async (result) => {
        if (result.status === 200) {
          ...
          await axios
            .post("www.thekift.shop:8080/toGiveContributePoint", {
  ...
  async function ChangePriceNFTOnTheMarket(priceSellerPut, result) {
    ...
    await axios
      .post(
        "www.thekift.shop:8080/listItemOnchange",
        {
          openseaId: URLparam,
          price: priceSellerPut,
          from: result.from,
  ...
  async function CancleNFTOnTheMarket(result) {
    ...
    await axios
      .post(
        "www.thekift.shop:8080/listItemOncancel",
        {
          openseaId: URLparam,
          isSale: false,
          price: 0,
  ...
  async function soldoutNFTOnTheMarket(to, from, itemprice) {
    ...
    await axios
      .post(
        "www.thekift.shop:8080/listItemOnbuy",
        {
          openseaId: URLparam,
          price: 0,
          isSale: false,
